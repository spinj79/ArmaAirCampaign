...
_distTimeMultip = 2; //(time = distance * _distTimeMultip)
_Citys = ["ftravel_PassengerTerminal", "ftravel_A10","ftravel_F15", "ftravel_F16", "ftravel_F15C", "ftravel_F22","ftravel_F35","ftravel_ControlTower","ftravel_sgs","ftravel_lgc","ftravel_hgc", "ftravel_gunship","ftravel_groundwar"];	//These have to be markers!!! - Marker names will be displayed as the name of the location
...
if (_mode == 3) exitwith {
	...
	*/
	...
	//***_Price = round (_distance * _distPriceMult);
	_txt = parseText "<t shadow='true'><t shadowColor='#ff0000'><t align='center'><t underline='1'><t color='#15FF00'><t size='1.8'>Fast Travel System</t></t></t></t></t></t><br/><br/>Your journey is going to start in 2 seconds.";
	hint _txt;
	sleep 2;
